 ...
 * client.
 *
 * Keys and tagging y.hrules are organized as arrays and defined in config.h.
 *
...
/* dwm systray implementation.
 * adapted for my personal fork
 */
...
/*
   Systray DWM patch implementation
   Adapted for my own fork
*/
